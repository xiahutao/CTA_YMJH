...
if __name__ == '__main__':
    ...
    # symbols_all = ['J', 'HC', 'AP', 'SC', 'MA', 'I', 'TF', 'TA', 'RB', 'ZC', 'JM', 'IH', 'M', 'T', 'RU', 'CF', 'AU',
    #                'NI', 'AG', 'PP', 'IC', 'IF', 'C', 'CU', 'JD', 'A', 'L', 'V', 'B', 'SR', 'SN', 'RM']  # sharp>0.2所有品种
    # symbols_all = ['AP', 'HC', 'J', 'TA', 'SC', 'I', 'RU', 'TF', 'RB', 'ZC', 'M', 'MA', 'AU', 'AG', 'NI', 'C', 'CU',
    ...
    for each in run_symbols_0:
        ...
        result_folder = 'e://Strategy//YMJH//backtest//2017%s_mutipara_zs' % (
