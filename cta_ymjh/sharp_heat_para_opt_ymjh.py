...
if __name__ == "__main__":
    ...
    l_period_lst = [i for i in range(11, 71, 4)]
                    ...
                    for m in range(i-1, i+2):
                        ...
                        for n in range(j-1, j+2):
                            ...
                            if temp_s_period >= temp_l_period:
                                ...
                                result_folder = 'e://Strategy//YMJH//better//week_ymjh_%s_%s_%s' % (
    ...
    print(ret)
    ret.to_csv('e:/Strategy/YMJH/para/' + 'para_opt_history_week.csv')
